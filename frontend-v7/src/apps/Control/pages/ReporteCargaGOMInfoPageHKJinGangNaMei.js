...
import ReporteCargaGOMInfoHKJinGangNaMei from '../components/ReporteCargaGOMInfoHKJinGangNaMei'
import ProgramacionVentanaContextProvider from '../contexts/ProgramacionVentanaContext'

export const ReporteCargaGOMInfoPageHKJinGangNaMei = () => {
  return (
    <div className="grid">
        ...
        <CargaBodegaContextProvider>
          <ProgramacionVentanaContextProvider>
            <ReporteCargaGOMContextProvider>
              <ReporteCargaGOMInfoHKJinGangNaMei />
            </ReporteCargaGOMContextProvider>
          </ProgramacionVentanaContextProvider>
        </CargaBodegaContextProvider>
      </BarcoContextProvider>
