...
import ReporteCargaGOMInfoGlobalCargoTrading from '../components/ReporteCargaGOMInfoGlobalCargoTrading'
import ProgramacionVentanaContextProvider from '../contexts/ProgramacionVentanaContext'

export const ReporteCargaGOMInfoPageGlobalCargoTrading = () => {
  return (
    <div className="grid">
        ...
        <CargaBodegaContextProvider>
          <ProgramacionVentanaContextProvider>
            <ReporteCargaGOMContextProvider>
              <ReporteCargaGOMInfoGlobalCargoTrading />
            </ReporteCargaGOMContextProvider>
          </ProgramacionVentanaContextProvider>
        </CargaBodegaContextProvider>
      </BarcoContextProvider>
