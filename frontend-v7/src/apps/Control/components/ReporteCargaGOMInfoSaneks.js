...
import ReporteCargaGOMInfoCardSaneks from './ReporteCargaGOMInfoCardSaneks'
import ProgramacionVentanaSaneks from './ProgramacionVentanaSaneks'

function ReporteCargaGOMInfoSaneks() {
      ...
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'SANEKS' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardSaneks key={barcos.id} barcos={barcos} />
            )
        )
      )}
      <ProgramacionVentanaSaneks></ProgramacionVentanaSaneks>
    </>
  )
}

export default ReporteCargaGOMInfoSaneks
