...
import ReporteCargaGOMInfoCardCrec10 from './ReporteCargaGOMInfoCardCrec10'
import ProgramacionVentanaCrec10 from './ProgramacionVentanaCrec10'

function ReporteCargaGOMInfoCrec10() {
      ...
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'CREC 10' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardCrec10 key={barcos.id} barcos={barcos} />
            )
        )
      )}
      <ProgramacionVentanaCrec10></ProgramacionVentanaCrec10>
    </>
  )
}

export default ReporteCargaGOMInfoCrec10
