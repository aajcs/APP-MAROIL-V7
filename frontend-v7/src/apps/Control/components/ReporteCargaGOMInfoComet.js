...
import ReporteCargaGOMInfoCardComet from './ReporteCargaGOMInfoCardComet'
import ProgramacionVentanaComet from './ProgramacionVentanaComet'

function ReporteCargaGOMInfoComet() {
      ...
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'COMET' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardComet key={barcos.id} barcos={barcos} />
            )
        )
      )}
      <ProgramacionVentanaComet></ProgramacionVentanaComet>
    </>
  )
}

export default ReporteCargaGOMInfoComet
