...
import ReporteCargaGOMInfoCardMbengueSarl from './ReporteCargaGOMInfoCardMbengueSarl'
import ProgramacionVentanaMbengueSarl from './ProgramacionVentanaMbengueSarl'

function ReporteCargaGOMInfoMbengueSarl() {
  ...
  return (
    <>
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'MBENGUE SARL' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardMbengueSarl
                key={barcos.id}
                barcos={barcos}
              />
            )
      ...
      <ProgramacionVentanaMbengueSarl></ProgramacionVentanaMbengueSarl>
    </>
  )
}

export default ReporteCargaGOMInfoMbengueSarl
