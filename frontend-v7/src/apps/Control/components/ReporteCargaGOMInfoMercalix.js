...
import ReporteCargaGOMInfoCardMercalix from './ReporteCargaGOMInfoCardMercalix'
import ProgramacionVentanaMercalix from './ProgramacionVentanaMercalix'

function ReporteCargaGOMInfoMercalix() {
  ...
  return (
    <>
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'MERCALIX' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardMercalix
                key={barcos.id}
                barcos={barcos}
              />
            )
      ...
      <ProgramacionVentanaMercalix></ProgramacionVentanaMercalix>
    </>
  )
}

export default ReporteCargaGOMInfoMercalix
