...
import ReporteCargaGOMInfoCardPraxlan from './ReporteCargaGOMInfoCardPraxlan'
import ProgramacionVentanaPraxlan from './ProgramacionVentanaPraxlan'

function ReporteCargaGOMInfoPraxlan() {
      ...
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'PRAXLAN' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardPraxlan key={barcos.id} barcos={barcos} />
            )
        )
      )}
      <ProgramacionVentanaPraxlan></ProgramacionVentanaPraxlan>
    </>
  )
}

export default ReporteCargaGOMInfoPraxlan
