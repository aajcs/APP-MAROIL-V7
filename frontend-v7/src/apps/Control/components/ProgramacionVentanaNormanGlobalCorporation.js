...
const ProgramacionVentanaNormanGlobalCorporation = () => {
  ...
  const agentaCard = () => {
    programacionVentanas.map((events) => {
      if (events.buqueClienteVenta === 'NORMAN GLOBAL CORPORATION') {
        if (
...
export default ProgramacionVentanaNormanGlobalCorporation
