...
import ReporteCargaGOMInfoCardRezelCatalysts from './ReporteCargaGOMInfoCardRezelCatalysts'
import ProgramacionVentanaRezelCatalysts from './ProgramacionVentanaRezelCatalysts'

function ReporteCargaGOMInfoRezelCatalysts() {
  ...
  return (
    <>
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'REZEL CATALYSTS' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardRezelCatalysts
                key={barcos.id}
                barcos={barcos}
              />
            )
      ...
      <ProgramacionVentanaRezelCatalysts></ProgramacionVentanaRezelCatalysts>
    </>
  )
}

export default ReporteCargaGOMInfoRezelCatalysts
