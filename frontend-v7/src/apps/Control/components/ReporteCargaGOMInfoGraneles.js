...
import ReporteCargaGOMInfoCardGraneles from './ReporteCargaGOMInfoCardGraneles'
import ProgramacionVentanaGraneles from './ProgramacionVentanaGraneles'

function ReporteCargaGOMInfoGraneles() {
  ...
  return (
    <>
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'GRANELES' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardGraneles
                key={barcos.id}
                barcos={barcos}
              />
            )
      ...
      <ProgramacionVentanaGraneles></ProgramacionVentanaGraneles>
    </>
  )
}

export default ReporteCargaGOMInfoGraneles
