...
import ReporteCargaGOMInfoCardRacOverseas from './ReporteCargaGOMInfoCardRacOverseas'
import ProgramacionVentanaRacOverseas from './ProgramacionVentanaRacOverseas'

function ReporteCargaGOMInfoRacOverseas() {
  ...
  return (
    <>
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'RAC OVERSEAS' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardRacOverseas
                key={barcos.id}
                barcos={barcos}
              />
            )
      ...
      <ProgramacionVentanaRacOverseas></ProgramacionVentanaRacOverseas>
    </>
  )
}

export default ReporteCargaGOMInfoRacOverseas
