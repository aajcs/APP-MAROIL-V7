...
const ProgramacionVentanaShanghaiInternationalLogistics = () => {
  ...
  const agentaCard = () => {
    programacionVentanas.map((events) => {
      if (events.buqueClienteVenta === 'SHANGHAI INTERNATIONAL LOGISTICS') {
        if (
...
export default ProgramacionVentanaShanghaiInternationalLogistics
