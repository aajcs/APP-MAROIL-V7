...
import ReporteCargaGOMInfoCardFarle from './ReporteCargaGOMInfoCardFarle'
import ProgramacionVentanaFarle from './ProgramacionVentanaFarle'

function ReporteCargaGOMInfoFarle() {
      ...
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'FARLE' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardFarle key={barcos.id} barcos={barcos} />
            )
        )
      )}
      <ProgramacionVentanaFarle></ProgramacionVentanaFarle>
    </>
  )
}

export default ReporteCargaGOMInfoFarle
