...
const ProgramacionVentanaEmpresaDeAsistenciasYServicios = () => {
  ...
  const agentaCard = () => {
    programacionVentanas.map((events) => {
      if (events.buqueClienteVenta === 'EMPRESA DE ASISTENCIAS Y SERVICIOS') {
        if (
...
export default ProgramacionVentanaEmpresaDeAsistenciasYServicios
