...
import ReporteCargaGOMInfoCardHKJinGangNaMei from './ReporteCargaGOMInfoCardHKJinGangNaMei'
import ProgramacionVentanaHKJinGangNaMei from './ProgramacionVentanaHKJinGangNaMei'

function ReporteCargaGOMInfoHKJinGangNaMei() {
  ...
  return (
    <>
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'HK JIN GANG NA MEI' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardHKJinGangNaMei
                key={barcos.id}
                barcos={barcos}
              />
            )
      ...
      <ProgramacionVentanaHKJinGangNaMei></ProgramacionVentanaHKJinGangNaMei>
    </>
  )
}

export default ReporteCargaGOMInfoHKJinGangNaMei
