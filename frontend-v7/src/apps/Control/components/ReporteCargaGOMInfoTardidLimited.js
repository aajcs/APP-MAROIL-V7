...
import ReporteCargaGOMInfoCardTardidLimited from './ReporteCargaGOMInfoCardTardidLimited'
import ProgramacionVentanaTardidLimited from './ProgramacionVentanaTardidLimited'

function ReporteCargaGOMInfoTardidLimited() {
  ...
  return (
    <>
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'TARDID LIMITED' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardTardidLimited
                key={barcos.id}
                barcos={barcos}
              />
            )
      ...
      <ProgramacionVentanaTardidLimited></ProgramacionVentanaTardidLimited>
    </>
  )
}

export default ReporteCargaGOMInfoTardidLimited
