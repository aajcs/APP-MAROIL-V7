...
import ReporteCargaGOMInfoCardMinasGusa from './ReporteCargaGOMInfoCardMinasGusa'
import ProgramacionVentanaMinasGusa from './ProgramacionVentanaMinasGusa'

function ReporteCargaGOMInfoMinasGusa() {
  ...
  return (
    <>
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'MINAS GUSA' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardMinasGusa
                key={barcos.id}
                barcos={barcos}
              />
            )
      ...
      <ProgramacionVentanaMinasGusa></ProgramacionVentanaMinasGusa>
    </>
  )
}

export default ReporteCargaGOMInfoMinasGusa
