...
import ReporteCargaGOMInfoCardArxhk from './ReporteCargaGOMInfoCardArxhk'
import ProgramacionVentanaArxhk from './ProgramacionVentanaArxhk'

function ReporteCargaGOMInfoArxhk() {
      ...
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'ARXHK' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardArxhk key={barcos.id} barcos={barcos} />
            )
        )
      )}
      <ProgramacionVentanaArxhk></ProgramacionVentanaArxhk>
    </>
  )
}

export default ReporteCargaGOMInfoArxhk
