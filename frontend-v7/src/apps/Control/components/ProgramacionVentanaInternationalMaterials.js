...
const ProgramacionVentanaInternationalMaterials = () => {
  ...
  const agentaCard = () => {
    programacionVentanas.map((events) => {
      if (events.buqueClienteVenta === 'INTERNATIONAL MATERIALS') {
        if (
...
export default ProgramacionVentanaInternationalMaterials
