...
import ReporteCargaGOMInfoCardGlobexWorldwide from './ReporteCargaGOMInfoCardGlobexWorldwide'
import ProgramacionVentanaGlobexWorldwide from './ProgramacionVentanaGlobexWorldwide'

function ReporteCargaGOMInfoGlobexWorldwide() {
  ...
  return (
    <>
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'GLOBEX WORLDWIDE' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardGlobexWorldwide
                key={barcos.id}
                barcos={barcos}
              />
            )
      ...
      <ProgramacionVentanaGlobexWorldwide></ProgramacionVentanaGlobexWorldwide>
    </>
  )
}

export default ReporteCargaGOMInfoGlobexWorldwide
