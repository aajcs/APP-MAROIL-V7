...
const ProgramacionVentanaSuperiorQuantitySDNBHD = () => {
  ...
  const agentaCard = () => {
    programacionVentanas.map((events) => {
      if (events.buqueClienteVenta === 'SUPERIOR QUANTITY SDN BHD') {
        if (
...
export default ProgramacionVentanaSuperiorQuantitySDNBHD
