...
const ProgramacionVentanaKaramanPetrokimyaAnonimSirketi = () => {
  ...
  const agentaCard = () => {
    programacionVentanas.map((events) => {
      if (events.buqueClienteVenta === 'KARAMAN PETROKIMYA ANONIM SIRKETI') {
        if (
...
export default ProgramacionVentanaKaramanPetrokimyaAnonimSirketi
