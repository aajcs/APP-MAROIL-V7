...
import ReporteCargaGOMInfoCardGlobulkDmcc from './ReporteCargaGOMInfoCardGlobulkDmcc'
import ProgramacionVentanaGlobulkDmcc from './ProgramacionVentanaGlobulkDmcc'

function ReporteCargaGOMInfoGlobulkDmcc() {
  ...
  return (
    <>
      {barcos.length === 0 ? (
        ...
        barcos.map(
          (barcos) =>
            ...
            barcos.buqueClienteVenta === 'GLOBULK DMCC' &&
            barcos.reporteCargaGOM.length !== 0 && (
              <ReporteCargaGOMInfoCardGlobulkDmcc
                key={barcos.id}
                barcos={barcos}
              />
            )
      ...
      <ProgramacionVentanaGlobulkDmcc></ProgramacionVentanaGlobulkDmcc>
    </>
  )
}

export default ReporteCargaGOMInfoGlobulkDmcc
